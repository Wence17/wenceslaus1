...
const About = ({ isDarkMode }) => {
  return (
    <motion.div
      className="w-full px-[12%] py-10 md:scroll-mt-20"
      id="about"
      initial={{ opacity: 0 }}
    ...
    >
      ...
      <motion.div
        ...
        className="flex w-full flex-col lg:flex-row items-center gap-5 md:gap-20 my-5 md:my-20"
      >
        <motion.div
        ...
        >
          ...
          <motion.ul
            ...
            className="grid grid-cols-6 md:flex items-center gap-3 md:gap-5"
          >
