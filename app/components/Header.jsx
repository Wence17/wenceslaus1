    ...
    <div className="w-11/12 max-w-3xl text-center mx-auto h-screen flex flex-col items-center justify-center gap-4">
      ...
      <div className="flex flex-col md:flex-row items-center gap-4 mt-4">
        <motion.a
          ...
          href="#contact"
          className="px-10 py-3 border border-white rounded-full bg-black text-white flex items-center gap-2 hover:shadow-xl dark:bg-transparent"
        >
          Contact me{" "}
        ...
        <motion.a
          ...
          download
          className="px-10 py-3 border rounded-full border-gray-500 flex items-center gap-2 hover:shadow-xl dark:bg-white dark:text-black"
        >
